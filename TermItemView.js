  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: '#000000', flex: 1 }}>
        ...
        <View style={{ backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center', flex: 1, flexDireciton: 'column', width: w, height: h, position: 'absolute' }}>
        ...
        <Swiper horizontal={ false } height={ 200 }>
